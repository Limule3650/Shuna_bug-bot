 ...
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
    interactiveMessage: {
      header: {
        title: "🐉Limule Solitarus",
        hasMediaAttachment: true,
        ...(await prepareWAMessageMedia({ image: { url: "https://i.ibb.co/K58Cgt4/x.jpg/thumb.jpeg" } }, { upload: XeonBotInc.waUploadToServer }))
      },
      body: {
        text: ""
      },
                    ...
                    XeonBotInc.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnailUrl: 'https://i.ibb.co/vmMx8PN/o.jpg/thumb.jpeg',
                ...
                await XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            thumbnailUrl: 'https://i.ibb.co/gJC8XNL/xx1.jpg/thumb.jpeg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
                        }
                    ...
                    XeonBotInc.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                title: botname,
                                body: ownername,
                                thumbnailUrl: 'https://i.ibb.co/K58Cgt4/x.jpg/thumb.jpeg',
                                sourceUrl: link,
                                mediaType: 1,
                                renderLargerThumbnail: true
                            }
